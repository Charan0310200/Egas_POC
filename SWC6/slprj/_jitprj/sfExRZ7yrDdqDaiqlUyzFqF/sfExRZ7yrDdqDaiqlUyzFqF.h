...
typedef struct
{
    ...
    real32_T *c3_In2;
    real32_T *c3_Out1;
    real32_T c3_Torque_Decel_Limit;
    uint8_T *c3_SafetyStatus;
    uint8_T *c3_Norma;
...
DLL_EXPORT_CC void c3_i_emlrt_marshallIn(SimStruct *S, gvar_instance *ptr_gvar_instance, const mxArray *c3_nullptr, const char_T *c3_identifier, boolean_T c3_y[4]);
DLL_EXPORT_CC void c3_j_emlrt_marshallIn(SimStruct *S, gvar_instance *ptr_gvar_instance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, boolean_T c3_y[4]);
