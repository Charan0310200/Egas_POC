...
#include "blas.h"
#include "lapacke.h"
#include "sZlV2kd7Hbg3Q5OhnWGxOTH.h"
...
void initialize_c3_ScpAp_SafetyStateManager(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    if (sf_get_output_port_reusable(S, 3) == 0) {
        *ptr_gvar_instance->c3_SafetyStatus = NORMAL;
    }
...
void sf_gateway_c3_ScpAp_SafetyStateManager(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    if ((int32_T)ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager == 0) {
        ...
        *ptr_gvar_instance->c3_SafetyStatus = *ptr_gvar_instance->c3_Normal;
...
const mxArray *get_sim_state_c3_ScpAp_SafetyStateManager(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    c3_u = (uint8_T)(int32_T)*ptr_gvar_instance->c3_SafetyStatus;
    c3_m_y = NULL;
    sf_mex_assign(&c3_m_y, sf_mex_create("y", &c3_u, 3, 0U, 0, 0U, 0), false);
    sf_mex_assign(&c3_b, c3_m_y, false);
    sf_mex_assign(&c3_c_y, sf_mex_create_enum("VechSafetyStatus_L2p_IDT", c3_b), false);
    sf_mex_destroy(&c3_b);
    sf_mex_setcell(c3_y, 1, c3_c_y);
    c3_d_y = NULL;
    sf_mex_assign(&c3_d_y, sf_mex_create("y", ptr_gvar_instance->c3_TrqCmd, 1, 0U, 0, 0U, 0), false);
...
void set_sim_state_c3_ScpAp_SafetyStateManager(SimStruct *S, gvar_instance *ptr_gvar_instance, const mxArray *c3_st)
{
    ...
    *ptr_gvar_instance->c3_SafetyStatus = c3_c_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 1)), "SafetyStatus");
    *ptr_gvar_instance->c3_TrqCmd = c3_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 2)), "TrqCmd");
    ...
    *c3_isValueBrowsable = 1U;
    switch (c3_ssIdNumber) {
      ...
      case 42U:
        ...
        break;
      case 44U:
        c3_c = (uint8_T)(int32_T)*ptr_gvar_instance->c3_SafetyStatus;
        ...
        break;
      case 47U:
        c3_c = (uint8_T)(int32_T)*ptr_gvar_instance->c3_Normal;
        sf_mex_assign(&c3_d, sf_mex_create("unnamed temp", &c3_c, 3, 0U, 0, 0U, 0), false);
        sf_mex_assign(c3_mxData, sf_mex_create_enum("VechSafetyStatus_L2p_IDT", c3_d), false);
        break;
    }
    sf_mex_destroy(&c3_b);
    sf_mex_destroy(&c3_d);
...
void init_simulink_io_address(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    ptr_gvar_instance->c3_SafetyStatus = (uint8_T *)ssGetOutputPortSignal_wrapper(S, 3);
    ptr_gvar_instance->c3_Normal = (uint8_T *)ssGetInputPortSignal_wrapper(S, 7);
    ...
    ptr_gvar_instance->c3_Out1 = (real32_T *)ssGetInputPortSignal_wrapper(S, 8);
}
