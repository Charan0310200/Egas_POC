...
#include "blas.h"
#include "lapacke.h"
#include "su1H87SWW7YT3m4EadGs1AH.h"
...
const mxArray *get_sim_state_c3_ScpAp_SafetyStateManager(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    c3_h_y = NULL;
    sf_mex_assign(&c3_h_y, sf_mex_create("y", &ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager, 3, 0U, 0, 0U, 0), false);
    sf_mex_setcell(c3_y, 6, c3_h_y);
    c3_i_y = NULL;
    sf_mex_assign(&c3_i_y, sf_mex_create("y", &ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager, 7, 0U, 0, 0U, 0), false);
...
void set_sim_state_c3_ScpAp_SafetyStateManager(SimStruct *S, gvar_instance *ptr_gvar_instance, const mxArray *c3_st)
{
    ...
    *ptr_gvar_instance->c3_VechSafetyStatus_L2p = c3_c_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 2)), "VechSafetyStatus_L2p");
    ...
    ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager = c3_e_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 6)), "is_active_c3_ScpAp_SafetyStateManager");
    ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager = c3_g_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 7)), "is_c3_ScpAp_SafetyStateManager");
