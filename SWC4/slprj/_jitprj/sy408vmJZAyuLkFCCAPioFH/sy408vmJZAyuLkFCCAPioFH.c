...
#include "blas.h"
#include "lapacke.h"
#include "sy408vmJZAyuLkFCCAPioFH.h"
...
void initSimStructsc3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
    (void)ptr_gvar_instance;
}

void initSubchartIOPointersc3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
    (void)ptr_gvar_instance;
}

void initialize_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager_New = 0U;
    ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New = (uint32_T)c3_IN_NO_ACTIVE_CHILD;
}

void initialize_params_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
    (void)ptr_gvar_instance;
}

void mdl_start_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)ptr_gvar_instance;
    sim_mode_is_external(S);
}

void mdl_terminate_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
    (void)ptr_gvar_instance;
}

void mdl_setup_runtime_resources_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
...
void mdl_cleanup_runtime_resources_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
...
void enable_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)ptr_gvar_instance;
    sf_get_time(S);
}

void disable_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)ptr_gvar_instance;
    sf_get_time(S);
}

void c3_set_sim_state_side_effects_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
    if ((int32_T)ptr_gvar_instance->c3_doSetSimStateSideEffects != 0) {
        if ((ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New == c3_IN_Degrade) && (sf_mex_sub(ptr_gvar_instance->c3_setSimStateSideEffectsInfo, "setSimStateSideEffectsInfo", 1U, 2U) == 0.0)) {
            ptr_gvar_instance->c3_temporalCounter_i1 = 0U;
        }
        ptr_gvar_instance->c3_doSetSimStateSideEffects = 0U;
    }
...
void sf_gateway_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    c3_set_sim_state_side_effects_c3_ScpAp_SafetyStateManager_New(S, ptr_gvar_instance);
    sf_get_time(S);
    ...
    if ((int32_T)ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager_New == 0) {
        ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager_New = 1U;
        ptr_gvar_instance->c3_JITTransitionAnimation[0U] = 1U;
        ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New = c3_IN_Normal;
        *ptr_gvar_instance->c3_VechSafetyStatus_L2p = NORMAL;
        ...
        *ptr_gvar_instance->c3_BrkTrqRq = 0.0F;
        ...
        switch (ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New) {
          case c3_IN_Degrade:
            ...
            if ((int32_T)ptr_gvar_instance->c3_temporalCounter_i1 >= 25) {
                ...
                ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New = c3_IN_Energency_Stop;
          ...
          case c3_IN_Normal:
            if (*ptr_gvar_instance->c3_SafetyOverspeedFlag) {
                ...
                ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New = c3_IN_OverSpeed_Handling;
                ...
                *ptr_gvar_instance->c3_BrkTrqRq = ptr_gvar_instance->c3_Brake_Decel_Level;
                ...
                ptr_gvar_instance->c3_temporalCounter_i1 = 0U;
                ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New = c3_IN_Degrade;
    ...
    c3_update_jit_animation_c3_ScpAp_SafetyStateManager_New(S, ptr_gvar_instance);
}

void ext_mode_exec_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
    (void)ptr_gvar_instance;
}

void c3_update_jit_animation_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    (void)S;
    ptr_gvar_instance->c3_JITStateAnimation[0U] = (uint8_T)(ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New == c3_IN_Normal);
    ptr_gvar_instance->c3_JITStateAnimation[1U] = (uint8_T)(ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New == c3_IN_OverSpeed_Handling);
    ptr_gvar_instance->c3_JITStateAnimation[2U] = (uint8_T)(ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New == c3_IN_Degrade);
    ptr_gvar_instance->c3_JITStateAnimation[3U] = (uint8_T)(ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New == c3_IN_Energency_Stop);
}

const mxArray *get_sim_state_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    c3_l_y = NULL;
    sf_mex_assign(&c3_l_y, sf_mex_create("y", &c3_u, 3, 0U, 0, 0U, 0), false);
    sf_mex_assign(&c3_b, c3_l_y, false);
    ...
    c3_h_y = NULL;
    sf_mex_assign(&c3_h_y, sf_mex_create("y", &ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager_New, 3, 0U, 0, 0U, 0), false);
    sf_mex_setcell(c3_y, 6, c3_h_y);
    c3_i_y = NULL;
    sf_mex_assign(&c3_i_y, sf_mex_create("y", &ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New, 7, 0U, 0, 0U, 0), false);
    sf_mex_setcell(c3_y, 7, c3_i_y);
    c3_j_y = NULL;
    sf_mex_assign(&c3_j_y, sf_mex_create("y", &ptr_gvar_instance->c3_temporalCounter_i1, 3, 0U, 0, 0U, 0), false);
    sf_mex_setcell(c3_y, 8, c3_j_y);
    c3_k_y = NULL;
    sf_mex_assign(&c3_k_y, sf_mex_create("y", ptr_gvar_instance->c3_dataWrittenToVector, 11, 0U, 1, 0U, 1, 3), false);
    sf_mex_setcell(c3_y, 9, c3_k_y);
    sf_mex_assign(&c3_st, c3_y, false);
    return c3_st;
}

void set_sim_state_c3_ScpAp_SafetyStateManager_New(SimStruct *S, gvar_instance *ptr_gvar_instance, const mxArray *c3_st)
{
    const mxArray *c3_u;
    ...
    *ptr_gvar_instance->c3_VechSafetyStatus_L2p = c3_c_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 2)), "VechSafetyStatus_L2p");
    ...
    ptr_gvar_instance->c3_is_active_c3_ScpAp_SafetyStateManager_New = c3_e_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 6)), "is_active_c3_ScpAp_SafetyStateManager_New");
    ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New = c3_g_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 7)), "is_c3_ScpAp_SafetyStateManager_New");
    ptr_gvar_instance->c3_temporalCounter_i1 = c3_e_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 8)), "temporalCounter_i1");
    c3_i_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 9)), "dataWrittenToVector", ptr_gvar_instance->c3_dataWrittenToVector);
    sf_mex_assign(&ptr_gvar_instance->c3_setSimStateSideEffectsInfo, c3_k_emlrt_marshallIn(S, ptr_gvar_instance, sf_mex_dup(sf_mex_getcell(c3_u, 10)), "setSimStateSideEffectsInfo"), true);
    sf_mex_destroy(&c3_u);
...
const mxArray *c3_sfAfterOrElapsed(SimStruct *S, gvar_instance *ptr_gvar_instance)
{
    ...
    (void)S;
    c3_b = NULL;
    if (ptr_gvar_instance->c3_is_c3_ScpAp_SafetyStateManager_New == c3_IN_Degrade) {
...
void c3_i_emlrt_marshallIn(SimStruct *S, gvar_instance *ptr_gvar_instance, const mxArray *c3_nullptr, const char_T *c3_identifier, boolean_T c3_y[3])
{
    emlrtMsgIdentifier c3_thisId;
    c3_thisId.fIdentifier = (const char_T *)c3_identifier;
    c3_thisId.fParent = NULL;
...
void c3_j_emlrt_marshallIn(SimStruct *S, gvar_instance *ptr_gvar_instance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId, boolean_T c3_y[3])
{
    int32_T c3_c;
    boolean_T c3_b[3];
    (void)S;
