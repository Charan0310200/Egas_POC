...
PRODUCT_NAME              = ScpAp_SafetyModeManager
MAKEFILE                  = ScpAp_SafetyModeManager.mk
MATLAB_ROOT               = F:/Matlab_2025B
MATLAB_BIN                = F:/Matlab_2025B/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = F:/POC/EGas_Models/Git_Clone/Egas_POC/SWC3
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = ScpAp_SafetyModeManager_comp.rsp
CMD_FILE                  = ScpAp_SafetyModeManager.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/ScpAp_SafetyModeManager.exe
...
DEFINES_STANDARD = -DMODEL=ScpAp_SafetyModeManager -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/stub/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/stub/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/stub/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/stub/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/ScpAp_SafetyModeManager_autosar_rtw/stub/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
